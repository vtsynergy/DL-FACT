...
## How to run
1. Run the [enhancement model](https://github.com/vtsynergy/DECT/tree/main/enhancement_model). The enhancement model will generate pre-enhanced (original) CT scans (.nii) and post-enhanced CT scans.
